(function(window, document, undefined){
	var 	image = new Image(),
			...
			tiles = [],
			slots = [],
			SPRITE_SHEET = "url('../../imagenes/eventos_puzzles/miraitowa_v2_escalado.png')",
			mouseX,
			mouseY,
			offsetX,
			offsetY,
	...
	function mouseDown(e){
		...
		if(c == ROWS * COLS){
			...
			$("img#exito").css("display","block");
			$("img#exito").fadeOut(3500);
	...
	image.onload = init;
	image.src = "../../imagenes/eventos_puzzles/miraitowa_v2_escalado.png";
